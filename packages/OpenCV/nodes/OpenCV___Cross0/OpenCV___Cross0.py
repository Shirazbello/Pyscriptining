...
class Cross_NodeInstance(NodeInstance):
    def __init__(self, parent_node: Node, flow, configuration=None):
        super(Cross_NodeInstance, self).__init__(parent_node, flow, configuration)
    ...
    def update_event(self, input_called=-1):
       ...
       # self.iter = self.input(2)
        ...
        self.res = cv2.morphologyEx(self.img, cv2.MORPH_CROSS,self.kern)
